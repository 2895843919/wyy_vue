...
// import playlist_all from '../views/playlist/All.vue' //歌单页item
// import taste from '../views/taste/index.vue' //每日推荐歌单
// import search from '../views/search/index.vue' //搜索
// import album from '../views/album/album.vue' //专辑页
// import album_item from '../views/album/album_item.vue' //专辑item
...
const Router = createRouter({
    ...
    },
    {
        ...
        name: 'discover',
        component: () =>
            import('../components/discover/index.vue'),
        meta: { keepAlive: true },
